...
off_t stringblock_append_string_force(struct stringblock_helper *shelper, const char *string, size_t slength);
off_t stringblock_append_string_safely(struct stringblock_helper *shelper, const char *string, size_t slength);
#endif